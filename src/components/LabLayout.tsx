...
const MODULOS: { letra: ModuleKey; nome: string; icon: IconName; ativo: boolean }[] = [
  ...
  { letra: 'G', nome: 'VENDAS OS',                 icon: 'clipboard', ativo: true  },
...
const OPCOES: Record<ModuleKey, Opcao[]> = {
  ...
  J: [
    ...
    { num: 2, label: 'CONTAS A RECEBER',   to: '/lab/contas-receber' },
    { num: 3, label: 'CONTAS A PAGAR',     to: '/lab/contas-pagar' },
    { num: 4, label: 'CONTROLE BANCÁRIO',  to: '/lab/bancario-lab' },
    { num: 5, label: 'VENDEDORES',         to: '/lab/vendedores' },
  ],
  K: [],
  L: [],
};
