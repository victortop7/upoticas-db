          ...
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'16px' }}>
            ...
            <div style={{ display:'flex', gap:'6px' }}>
              <button onClick={handleSeed} disabled={seeding}
                style={{ padding:'5px 12px', fontSize:'11px', fontWeight:'700', background:R.alt, color:R.txt, border:`1px outset ${R.bdr}`, cursor:seeding?'not-allowed':'pointer', fontFamily:'inherit', textTransform:'uppercase' }}>
              ...
              return (
                <div key={i} style={{ position:'relative', background:R.panel, border:`2px outset ${R.bdr}` }}>
                  <button onClick={() => { setBusca(''); setListaFiltro(i); }}
                    ...
                    <span style={{ fontSize:'11px', fontWeight:'700', color:R.dim, textTransform:'uppercase', letterSpacing:'0.5px' }}>LISTA {i + 1}</span>
